...
const MenubarSeparator = ({ children, ...rest }: MenubarSeparatorProps) => (
  <MenubarPrimitive.Separator
    className="mx-1.5 my-1 h-px bg-gray-200 dark:bg-gray-700"
    {...rest}>
    {children}
  </MenubarPrimitive.Separator>
);
...
const MenubarTrigger = ({ children, ...rest }: MenubarTriggerProps) => (
  <MenubarPrimitive.Trigger
    className={clsx(
      'cursor-default radix-disabled:cursor-not-allowed radix-disabled:opacity-50',
      'radix-state-open:bg-gray-100 dark:radix-state-open:bg-gray-900',
      'rounded-md px-4 py-1 text-sm hover:bg-gray-100 dark:hover:bg-gray-900',
      'text-sm font-medium',
...
const MenubarSubTrigger = ({ children, ...rest }: MenubarSubTriggerProps) => (
  <MenubarPrimitive.SubTrigger
    className={clsx(
      'cursor-default radix-disabled:cursor-not-allowed radix-disabled:opacity-50',
      'rounded-md px-3 py-1 text-sm hover:bg-gray-100 dark:hover:bg-gray-900',
      'text-sm font-medium',
      'text-gray-700 dark:text-gray-100',
      'focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75',
    )}
...
const MenubarCheckboxItem = ({
  ...
  <MenubarPrimitive.CheckboxItem
    ...
    <div className="flex items-center">
      <div className="relative -ml-1 h-3.5 w-3.5">
        <MenubarPrimitive.ItemIndicator>
          <CheckIcon className="-ml-0.5 mr-1.5 h-3.5 w-3.5" />
        </MenubarPrimitive.ItemIndicator>
      </div>
...
const Menubar = (props: MenubarProps) => {
  ...
  return (
    <MenubarPrimitive.Root className="relative flex flex-row -space-x-1 rounded-lg bg-white dark:bg-gray-800">
