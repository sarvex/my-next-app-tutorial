              ...
              <TooltipPrimitive.Content
                ...
                <div className="flex items-center space-x-3 text-gray-700 dark:text-gray-300">
                  ...
                  <div className="flex items-center justify-center space-x-1">
                    <kbd className="flex h-5 w-auto select-none items-center justify-center rounded-md bg-black/10 px-1.5 pt-0.5 font-bold hover:cursor-pointer dark:bg-white/10">
                      ⌘{' '}
                    </kbd>
                    <span className="">+</span>
                    <kbd className="flex h-5 w-auto select-none items-center justify-center rounded-md bg-black/10 px-1.5 text-xs font-bold hover:cursor-pointer dark:bg-white/10">
                      K
                    </kbd>
                  </div>
                </div>
